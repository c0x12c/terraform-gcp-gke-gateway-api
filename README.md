...
| <a name="input_enabled_field_manager"></a> [enabled\_field\_manager](#input\_enabled\_field\_manager) | Specifies whether to enable field manager for the resource. | `bool` | `false` | no |
